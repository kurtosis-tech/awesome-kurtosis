...
2. Now, Run 
    ...
    Each EL and CL client require data that differs per client, so we leverage the `prelaunch-data-generator`, built off this [Docker image](https://github.com/ethpandaops/ethereum-genesis-generator), to create the necessary genesis files and secrets.
